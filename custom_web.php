                ...
                <div class="row">
                    ...
                    <div class="container">
                        ...
                        <div class="container mt-3">
                            ...
                            <ul class="container">
                                <li class="mb-2">
                                    <strong class="me-1">Shopify </strong>includes built-in features like fraud analysis, payment gateways, and product management. Folio3 Shopify Maintenance Services can help maintain these features.
                                    </li>
                                <li class="mb-2">
