                    ...
                    <div class="row align-items-md-center">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 order-md-3">
                            <div class="text-sm-right">
                                <a class="ttm-btn ttm-btn-size-md ttm-btn-style-border ttm-icon-btn-left ttm-btn-color-white" href="mailto:codelockinfo@gmail.com" title="" style="text-transform: lowercase;"> codelockinfo@gmail.com <i class="fa fa-envelope-o"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                               ...
                               <div class="textwidget widget-text">
                                    ...
                                    <div class="social-icons circle social-hover">
                                        <ul class="list-inline">
                                            <li class="social-facebook"><a class="tooltip-top" target="_blank" href="https://business.facebook.com/latest/home?asset_id=102472537971901&business_id=222081448788597&nav_ref=bm_home_redirect" data-tooltip="Facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>

                                            <li class="social-twitter"><a class="tooltip-top" target="_blank" href="https://www.instagram.com/codelocksolutions/" data-tooltip="Instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
